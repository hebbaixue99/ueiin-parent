    ...
    (function (ScrollFix) {
        ...
        ScrollFix.Watcher.prototype = {
            ...
            updateFixed: function () {
                ...
                //document.title = this.element.clientHeight;
                // position
                if (this.options.syncPosition) {
                    var currentScrollLeft = $(window).scrollLeft();
                    var substituteLeftOffset = this.getElementX(this.substitute);
                    $(this.element).offset({top:41});//.top = 42 ;
                   // {top:100,left:0}
            ...
            attach: function () {
                if (!this.attached) {
                   ...
                   // $(window).touchstart(this.updateEventHandler);
                    //$(window).touchmove(this.updateEventHandler);
                    //$(window).touchend(this.updateEventHandler);
                    window.addEventListener('touchstart', this.updateEventHandler);
                    window.addEventListener('touchmove', this.updateEventHandler);
                    window.addEventListener('touchend', this.updateEventHandler);
            ...
            pulse: function () {
               ...
               // document.title = $("#bar").offset().top;
                
                if (this.fixed) {
                    if ($(this.element).offset().top>43
